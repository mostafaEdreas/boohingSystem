        ...
        @if ($errors->any())
            <div class="alert alert-danger border-0 shadow-sm mb-4 d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width:20px; height:20px;" class="me-2">
                    <path fill-rule="evenodd" d="M9.401 3.003c.115-.283.392-.45.686-.45.294 0 .571.167.686.45l6.4 15.601a.75.75 0 01-.686 1.05H3.614a.75.75 0 01-.686-1.05l6.473-15.601zM12 11.25a.75.75 0 00-1.5 0v2.5a.75.75 0 001.5 0v-2.5zm-1.5 6a.75.75 0 111.5 0 .75.75 0 01-1.5 0z" clip-rule="evenodd" />
                </svg>
            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-3">
                    <label class="small fw-bold text-muted ms-1 mb-1 d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="width:14px; height:14px;" class="me-1">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                        </svg>
                        City
                    </label>
                    <input type="text" name="h_city" class="form-control border-0 bg-white" placeholder="Where to?" value="{{ request('h_city') }}">
                </div>
                <div class="col-md-2">
                    <label class="small fw-bold text-muted ms-1 mb-1">Check-in</label>
                    <input type="date" name="res_checkin_date" class="form-control border-0 bg-white" value="{{ request('res_checkin_date', now()->format('Y-m-d')) }}">
                </div>
                <div class="col-md-2">
                    <label class="small fw-bold text-muted ms-1 mb-1">Check-out</label>
                    <input type="date" name="res_checkout_date" class="form-control border-0 bg-white" value="{{ request('res_checkout_date', now()->addDay()->format('Y-m-d')) }}">
                </div>
                <div class="col-md-2">
                    <label class="small fw-bold text-muted ms-1 mb-1">Guests</label>
                    <input type="number" name="r_guests" class="form-control border-0 bg-white" min="1" value="{{ request('r_guests', 1) }}">
                </div>
                <div class="col-md-3">
                    <button type="submit" class="btn btn-dark w-100 py-2 fw-bold d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" style="width:18px; height:18px;" class="me-2">
...
<div class="container mb-5">
        ...
        <div class="card border-0 shadow-sm mb-4 overflow-hidden result-card">
            <div class="row g-0">
                <div class="col-md-4 bg-light d-flex align-items-center justify-content-center position-relative">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.5" stroke="currentColor" class="text-muted opacity-25" style="width: 100px;">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <p class="text-muted small mb-0 d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width:14px; height:14px;" class="text-primary me-1">
                            ...
                            <div class="d-flex justify-content-between align-items-center py-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                                <div>
                                    ...
                                    <small class="text-muted d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width:14px; height:14px;" class="me-1">
                                ...
                                <div class="text-end">
                                    <span class="text-muted small d-block mb-1">${{ number_format($room->price_per_night, 2) }} / night</span>
                                    <div class="text-success fw-bold h5 mb-2">
                                        Total: ${{ number_format($room->total_calculated_price, 2) }}
                                    </div>
                                    <button class="btn btn-primary btn-sm px-4 shadow-sm fw-bold">Select Room</button>
                                </div>
                            </div>
                            @endforeach
                        </div>
    ...
    @empty
        <div class="text-center py-5 card border-0 shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="text-muted mx-auto mb-3" style="width: 64px;">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
            </svg>
